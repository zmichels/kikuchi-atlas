...
- [ ] Directional and axial arrays are typed, immutable, finite, hash-addressed, and plain-data described.
- [ ] The recipe fixes all density, tolerance, RNG, serialization, and MTEX-version semantics.
- [ ] Only the `32` smoke and `128` acceptance half-size profiles are accepted.
