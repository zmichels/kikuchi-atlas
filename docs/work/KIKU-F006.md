...
Decouple phase-specific reflector evidence from dense master-pattern rendering,
then use one configurable active crystal-to-sample orientation to publish a
comparable five-phase family of standard and slightly wider vector-first
hemisphere designs.
